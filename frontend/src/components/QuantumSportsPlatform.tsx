        ...
        <div className='quantum-card p-6 rounded-2xl'>
          ...
          <div className='space-y-3'>
            <div className='flex justify-between items-center'>
              ...
              <span className='text-electric-400 font-bold'>12ms avg</span>
            </div>
            <div className='flex justify-between items-center'>
        ...
        <div className='quantum-card p-6 rounded-2xl'>
          ...
          <div className='space-y-2'>
            <div className='flex justify-between'>
              <span className='text-gray-300'>Lakers vs Warriors O/U</span>
              <span className='text-green-400'>+$420</span>
            </div>
            <div className='flex justify-between'>
              <span className='text-gray-300'>LeBron 25+ Points</span>
              <span className='text-green-400'>+$315</span>
            </div>
            <div className='flex justify-between'>
              <span className='text-gray-300'>Curry 6+ Threes</span>
...
const WorkingAnalytics: React.FC = () => {
  return (
    <div className='p-8 space-y-6'>
      <div className='text-center mb-8'>
        <h1 className='text-4xl font-bold text-white mb-4 animate-cyber-pulse'>
...
// Working MoneyMaker Component
const WorkingMoneyMaker: React.FC = () => {
  return (
    <div className='p-8 space-y-6'>
      <div className='text-center mb-8'>
        <h1 className='text-4xl font-bold text-white mb-4 animate-cyber-pulse'>
